 ...
 struct _ply_terminal
 {
   ...
   ply_list_t *active_vt_changed_closures;
 ...
 ply_terminal_new (const char *device_name)
 {
   ...
   terminal->active_vt_changed_closures = ply_list_new ();
 ...
 do_active_vt_changed (ply_terminal_t *terminal)
 {
   ...
   node = ply_list_get_first_node (terminal->active_vt_changed_closures);
   while (node != NULL)
     {
       ...
       next_node = ply_list_get_next_node (terminal->active_vt_changed_closures,
                                           node);
...
void
ply_terminal_watch_for_active_vt_changed (ply_terminal_t *terminal,
                                          ...
                                          void *user_data)
{
  ...
  ply_list_append_data (terminal->active_vt_changed_closures, closure);
}

void
ply_terminal_stop_watching_for_active_vt_changed (ply_terminal_t *terminal,
                                                  ply_terminal_active_vt_changed_handler_t active_vt_changed_handler,
                                                  void *user_data)
{
  ply_list_node_t *node;
  ...
  while (node != NULL)
    {
      ...
      if (closure->handler == active_vt_changed_handler &&
        ...
        {
          free (closure);
          ply_list_remove_node (terminal->active_vt_changed_closures, node);
        }
...
static void
free_active_vt_changed_closures (ply_terminal_t *terminal)
{
  ply_list_node_t *node;
  ...
  ply_list_free (terminal->active_vt_changed_closures);
}
...
ply_terminal_free (ply_terminal_t *terminal)
{
  ...
  free_active_vt_changed_closures (terminal);
  free (terminal->name);
  free (terminal);
}
